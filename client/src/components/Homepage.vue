<template>
  <div class="body-background">
    <div class="container white z-depth-2 right" style="height: 90.5%; margin: 4.5% 1% 0 0; padding: 2.5% 0 0 0;" v-if='openLogin == true'>
      ...
      <div id="login" class="col s10" style="padding: 20% 0 0 0;">
        <form class="col s10 form-container">
          ...
          <div class="row">
            <div class="col s5">
              <a class="btn waves-effect waves-light black" type="submit" @click='login' style="width:100%; color: black">Sign In</a>
            </div>
            <div class="col s5">
              <a class="btn waves-effect waves-light black" type="submit" @click='close' style="width:100%; margin: 0 0 0 5%; color: black">Cancel</a>
            </div>
          </div>
        </form>
      </div>
    </div>
    <div class="container white z-depth-2 right" style="height: 90.5%; margin: 4.5% 1% 0 0; padding: 2.5% 0 0 0;" v-if='openRegister == true'>
      <a href="#" class="btn black btn-large" style="cursor: default; margin: 0 0 0 -2%">Sign Up Here</a>
        ...
        <form class="col s10 form-container">
          ...
          <div class="row">
            <div class="col s5">
              <a class="btn waves-effect waves-light black" type="submit" style="width:100%; color: black" @click='register'>Sign Up</a>
            </div>
            <div class="col s5">
              <a class="btn waves-effect waves-light black" type="submit" @click='close' style="width:100%; margin: 0 0 0 5%; color: black">Cancel</a>
            </div>
