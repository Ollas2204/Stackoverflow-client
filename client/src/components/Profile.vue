        ...
        <div class="card-stacked">
          ...
          <div class="card-action">
            <div class="row" style="margin: 5% 0 0 0;">
              <div class="col s12 m12 slide-fwd-bottom" v-for='question in myQuestion'>
                <div class="card grey darken-3">
                  <div class="card-content white-text">
                    <div class="row">
                      ...
                      <div class="col " style="margin: -1% 0 0 0;">
                        <pre style="color:grey;">{{ question.time }}</pre>
                      </div>
                    </div>
                    <div class="left" style="margin: -1% 3% 0 4%;">
...
export default {
  ...
  created () {
    const all = this.$store.state.questions

    all.forEach(val => {
      if (val.UserId._id == this.$store.state.userData) {
        this.myQuestion.push(val)
      }
    })
  },
  methods : {
